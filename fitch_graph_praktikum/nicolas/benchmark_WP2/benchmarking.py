...
def benchmark_algos_on_graph(
    ...
    functions = [
        ...
        ('GreedyAvg_med', bi_partition_greedy_avg, average_weight_scoring, True, True),
        ('GreedySum_med', bi_partition_greedy_sum, average_weight_scoring, True, True),
        ...
        ('LeidenAvgMod_1_1_med', bi_partition_leiden_average_edge_cut_mod_gamma1_theta1, average_weight_scoring, True, True),
        ('LeidenAvg_1_7_001_med', bi_partition_leiden_average_edge_cut_gamma1_7_theta001, average_weight_scoring, True, True),
        ('LeidenAvgMod_1_7_001_med', bi_partition_leiden_average_edge_cut_mod_gamma1_7_theta001, average_weight_scoring, True, True),
    ]
